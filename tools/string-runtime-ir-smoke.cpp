//===- string-runtime-ir-smoke.cpp - execute generated string runtime -----===//
...
int main(int argc, char **argv) {
  ...
  if (!allvm_str_seal_record(
          ValidRecord.data(), ValidRecord.size(), Plain.data(), Plain.size(),
          Key.data(), Nonce.data(), 7U, 19U, 0U))
    return 3;
  ...
  LLVMContext C;
  Module M("authenticated-string-runtime-smoke", C);
